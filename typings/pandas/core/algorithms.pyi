...
if TYPE_CHECKING:
    ...
_hashtables = ...
def unique(values): # -> ArrayLike | tuple[ArrayLike, NDArray[Any]]:
    """
...
def unique_with_mask(values, mask: npt.NDArray[np.bool_] | None = ...): # -> ArrayLike | tuple[ArrayLike, NDArray[Any]]:
...
def take(arr, indices: TakeIndexer, axis: AxisInt = ..., allow_fill: bool = ..., fill_value=...): # -> ndarray[Any, dtype[Any]] | Index | Series:
    """
