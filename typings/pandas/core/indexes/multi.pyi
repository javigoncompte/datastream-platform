...
class MultiIndex(Index):
    ...
    def get_loc(self, key): # -> Any | slice[NDArray[intp] | intp, NDArray[intp] | intp, Any] | ndarray[Any, Any] | ndarray[Any, dtype[bool_]] | ndarray[Any, dtype[Any]] | slice[Any, Any, Any] | int | integer[Any] | ndarray[Any, dtype[signedinteger[_NBitIntP]]] | slice[int, int, Any] | None:
        """
    ...
    def get_loc_level(self, key, level: IndexLabel = ..., drop_level: bool = ...): # -> tuple[int | integer[Any] | NDArray[Any] | Any | ndarray[Any, dtype[bool_]] | ndarray[Any, Any] | ndarray[Any, dtype[signedinteger[_NBitIntP]]] | slice[NDArray[intp] | intp, NDArray[intp] | intp, Any] | slice[Any, Any, Any] | slice[int, int, Any] | None, tuple[Any, ...] | MultiIndex | Index | Any | None]:
        """
