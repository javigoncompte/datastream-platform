...
class SingleBlockManager(BaseBlockManager, SingleDataManager):
    ...
    def __getstate__(self): # -> tuple[list[Index], list[ndarray[Any, Any] | ExtensionArray], list[Any | Index], dict[str, dict[str, list[Index] | list[dict[str, ndarray[Any, Any] | ExtensionArray | slice[Any, Any, Any]]]]]]:
        ...
