...
from pandas._typing import AggFuncType, AnyAll, AnyArrayLike, ArrayLike, Axes, Axis, ColspaceArgType, CompressionOptions, CorrelationMethod, DropKeep, Dtype, FilePath, FloatFormatType, FormattersType, Frequency, FromDictOrient, IgnoreRaise, IndexKeyFunc, IndexLabel, JoinValidate, Level, MergeHow, MergeValidate, MutableMappingT, NaAction, NaPosition, NsmallestNlargestKeep, PythonFuncType, QuantileInterpolation, ReadBuffer, ReindexMethod, Renamer, Scalar, Self, SequenceNotStr, SortKind, StorageOptions, Suffixes, ToGbqIfexist, ToStataByteorder, ToTimestampHow, UpdateJoin, ValueKeyFunc, WriteBuffer, XMLParsers, npt
...
class DataFrame(NDFrame, OpsMixin):
    ...
    @doc(Series.swaplevel, klass=_shared_doc_kwargs["klass"], extra_params=dedent("""axis : {0 or 'index', 1 or 'columns'}, default 0
            ...
            'columns' for column-wise."""), examples=dedent("""\
        Examples
        --------
        >>> df = pd.DataFrame(
        ...     {"Grade": ["A", "B", "A", "C"]},
    ...
    def stack(self, level: IndexLabel = ..., dropna: bool | lib.NoDefault = ..., sort: bool | lib.NoDefault = ..., future_stack: bool = ...): # -> DataFrame | Series:
        """
    ...
    def unstack(self, level: IndexLabel = ..., fill_value=..., sort: bool = ...): # -> <subclass of DataFrame and Series> | DataFrame | Series:
        """
    ...
    def apply(self, func: AggFuncType, axis: Axis = ..., raw: bool = ..., result_type: Literal["expand", "reduce", "broadcast"] | None = ..., args=..., by_row: Literal[False, "compat"] = ..., engine: Literal["python", "numba"] = ..., engine_kwargs: dict[str, bool] | None = ..., **kwargs): # -> DataFrame | Series:
        """
    ...
    def mean(self, axis: Axis | None = ..., skipna: bool = ..., numeric_only: bool = ..., **kwargs): # -> Series | float | int:
        ...
    
    @doc(make_doc("median", ndim=2))
    def median(self, axis: Axis | None = ..., skipna: bool = ..., numeric_only: bool = ..., **kwargs): # -> Series | float | int:
        ...
    
    @doc(make_doc("sem", ndim=2))
    def sem(self, axis: Axis | None = ..., skipna: bool = ..., ddof: int = ..., numeric_only: bool = ..., **kwargs): # -> Series | float | int:
        ...
    
    @doc(make_doc("var", ndim=2))
    def var(self, axis: Axis | None = ..., skipna: bool = ..., ddof: int = ..., numeric_only: bool = ..., **kwargs): # -> Series | float | int:
        ...
    
    @doc(make_doc("std", ndim=2))
    def std(self, axis: Axis | None = ..., skipna: bool = ..., ddof: int = ..., numeric_only: bool = ..., **kwargs): # -> Series | float | int:
        ...
    
    @doc(make_doc("skew", ndim=2))
    def skew(self, axis: Axis | None = ..., skipna: bool = ..., numeric_only: bool = ..., **kwargs): # -> Series | float | int:
        ...
    
    @doc(make_doc("kurt", ndim=2))
    def kurt(self, axis: Axis | None = ..., skipna: bool = ..., numeric_only: bool = ..., **kwargs): # -> Series | float | int:
        ...
