...
@pytest.fixture
def multiindex_year_month_day_dataframe_random_data(): # -> NDFrame | Any | DataFrame:
    """
...
@pytest.fixture(params=["python", pytest.param("pyarrow", marks=td.skip_if_no("pyarrow")), pytest.param("pyarrow_numpy", marks=td.skip_if_no("pyarrow"))])
