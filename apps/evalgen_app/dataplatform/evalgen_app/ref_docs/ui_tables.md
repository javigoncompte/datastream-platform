...
Below are examples of various ways to use tables with MonsterUI.  `HTMX` can be used to add interactivity and this is an example of the UI components only.
